"""
Serviço de email para Django usando SendGrid
"""
import sys
...
def send_email_django(
    ...
    """
    Função helper para enviar email via SendGrid no Django
...
def send_template_email_django(
    to_emails: List[str],
    template_id: str,
    ...
    """
    Função helper para enviar email usando template do SendGrid no Django
